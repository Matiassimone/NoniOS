...
export const es = {
  ...
  'admin.tiles.addModal.gameTitle': 'Un juego',
  'admin.tiles.addModal.gameBody': 'Solitario Spider, sin internet ni publicidad',
  'admin.tiles.game.spider': 'Solitario',
